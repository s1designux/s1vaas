...
const raw: Omit<Camera, 'contractId'>[] = [
  ...
  { id: 'cam-02', siteId: 's-12', name: 'CAM-02 강남본점 주차장',        ip: '10.11.2.12', model: 'S1-IPX4500', firmware: '4.2.1', status: 'online',    recording: true,  codec: 'H.265', fps: 25, resolution: '1920x1080', storageGb: 256, zones: [], flags: { intrusionDetection: true,  faceMatching: false, lpr: true,  lineCrossing: true  }, sensitivity: 'high', updatedAt: t },
  ...
  { id: 'cam-04', siteId: 's-11', name: 'CAM-04 강남본점 옥상',          ip: '10.11.2.14', model: 'S1-IPX4500', firmware: '4.2.1', status: 'online',    recording: false, codec: 'H.265', fps: 30, resolution: '3840x2160', storageGb: 256, zones: [], flags: { intrusionDetection: true,  faceMatching: false, lpr: false, lineCrossing: true  }, sensitivity: 'high', updatedAt: t },
  { id: 'cam-21', siteId: 's-01', name: 'CAM-21 강남본점 2F 사무실',     ip: '10.11.2.15', model: 'S1-IPX3200', firmware: '4.2.0', status: 'online',    recording: true,  codec: 'H.264', fps: 25, resolution: '1920x1080', storageGb: 256, zones: [], flags: { intrusionDetection: false, faceMatching: true,  lpr: false, lineCrossing: false }, sensitivity: 'low',  updatedAt: t },
  { id: 'cam-22', siteId: 's-01', name: 'CAM-22 강남본점 3F 복도',       ip: '10.11.2.16', model: 'S1-IPX3200', firmware: '4.2.0', status: 'recording', recording: true,  codec: 'H.264', fps: 30, resolution: '1920x1080', storageGb: 256, zones: [], flags: { intrusionDetection: true,  faceMatching: false, lpr: false, lineCrossing: true  }, sensitivity: 'mid',  updatedAt: t },
  { id: 'cam-23', siteId: 's-01', name: 'CAM-23 강남본점 지하1층',       ip: '10.11.2.17', model: 'S1-IPX2100', firmware: '4.0.7', status: 'offline',   recording: false, codec: 'H.264', fps: 15, resolution: '1280x720',  storageGb: 128, zones: [], flags: { intrusionDetection: true,  faceMatching: false, lpr: false, lineCrossing: true  }, sensitivity: 'mid',  updatedAt: '2026-04-23T07:30:00+09:00' },
  { id: 'cam-24', siteId: 's-01', name: 'CAM-24 강남본점 4F 대회의실',   ip: '10.11.2.18', model: 'S1-IPX3200', firmware: '4.2.0', status: 'online',    recording: false, codec: 'H.264', fps: 30, resolution: '1920x1080', storageGb: 256, zones: [], flags: { intrusionDetection: false, faceMatching: true,  lpr: false, lineCrossing: false }, sensitivity: 'low',  updatedAt: t },
  { id: 'cam-25', siteId: 's-01', name: 'CAM-25 강남본점 주출입구',      ip: '10.11.2.19', model: 'S1-IPX4500', firmware: '4.2.1', status: 'recording', recording: true,  codec: 'H.265', fps: 30, resolution: '3840x2160', storageGb: 512, zones: [], flags: { intrusionDetection: true,  faceMatching: true,  lpr: true,  lineCrossing: true  }, sensitivity: 'high', updatedAt: t },
  { id: 'cam-26', siteId: 's-01', name: 'CAM-26 강남본점 후문',          ip: '10.11.2.20', model: 'S1-IPX3200', firmware: '4.2.0', status: 'online',    recording: true,  codec: 'H.264', fps: 25, resolution: '1920x1080', storageGb: 256, zones: [], flags: { intrusionDetection: true,  faceMatching: false, lpr: true,  lineCrossing: true  }, sensitivity: 'mid',  updatedAt: t },
  ...
  { id: 'cam-07', siteId: 's-13', name: 'CAM-07 서초지점 주차장',     ip: '10.12.3.23', model: 'S1-IPX4500', firmware: '4.2.1', status: 'online',    recording: true,  codec: 'H.265', fps: 30, resolution: '1920x1080', storageGb: 256, zones: [], flags: { intrusionDetection: true,  faceMatching: false, lpr: true,  lineCrossing: true  }, sensitivity: 'mid',  updatedAt: t },
  ...
  { id: 'cam-09', siteId: 's-14', name: 'CAM-09 송파 1F 매장',         ip: '10.13.4.32', model: 'S1-IPX3200', firmware: '4.1.9', status: 'recording', recording: true,  codec: 'H.264', fps: 30, resolution: '1920x1080', storageGb: 256, zones: [], flags: { intrusionDetection: true,  faceMatching: true,  lpr: false, lineCrossing: false }, sensitivity: 'high', updatedAt: t },
  { id: 'cam-10', siteId: 's-15', name: 'CAM-10 송파 주차장 A',        ip: '10.13.4.33', model: 'S1-IPX3200', firmware: '4.1.9', status: 'online',    recording: true,  codec: 'H.264', fps: 25, resolution: '1920x1080', storageGb: 256, zones: [], flags: { intrusionDetection: true,  faceMatching: false, lpr: true,  lineCrossing: true  }, sensitivity: 'mid',  updatedAt: t },
  { id: 'cam-11', siteId: 's-15', name: 'CAM-11 송파 옥외 정문',       ip: '10.13.4.34', model: 'S1-IPX4500', firmware: '4.2.1', status: 'online',    recording: false, codec: 'H.265', fps: 30, resolution: '3840x2160', storageGb: 256, zones: [], flags: { intrusionDetection: true,  faceMatching: false, lpr: false, lineCrossing: true  }, sensitivity: 'low',  updatedAt: t },
  ...
  { id: 'cam-13', siteId: 's-16', name: 'CAM-13 판교 R&D 서버룸',     ip: '10.14.5.42', model: 'S1-IPX4500', firmware: '4.2.1', status: 'recording', recording: true,  codec: 'H.265', fps: 30, resolution: '3840x2160', storageGb: 512, zones: [], flags: { intrusionDetection: true,  faceMatching: true,  lpr: false, lineCrossing: true  }, sensitivity: 'high', updatedAt: t },
  ...
  { id: 'cam-18', siteId: 's-17', name: 'CAM-18 부산 지사 로비',       ip: '10.15.6.53', model: 'S1-IPX3200', firmware: '4.1.9', status: 'online',    recording: true,  codec: 'H.264', fps: 30, resolution: '1920x1080', storageGb: 256, zones: [], flags: { intrusionDetection: false, faceMatching: true,  lpr: false, lineCrossing: false }, sensitivity: 'low',  updatedAt: t },
